...
">
  ...
  align-items: center;
">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="padding-left: 220px">
                <span aria-hidden="true">&times;</span>
            </button>
            ...
            <div style="margin-bottom: 10px;display: flex; gap: 3px; justify-content: center">
                <button style="border: none; background-color: white" id="registerBtnModal">Register</button>
                <script type="text/javascript">
                    document.getElementById('registerBtnModal').addEventListener('click', function () {
                        $('#loginModal').modal('hide');
                        $('#registerModal').modal('show');
                    });
                </script>
                <span>|</span>
                <a id="forgotPasswordModal">ForgotPassword</a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModalLabel"
    ...
    <div class="modal-body">
        <div id="otpModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="otpModalLabel"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
